...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { description: @tour.description, destination_id: @tour.destination_id, length: @tour.length, name: @tour.name, price: @tour.price } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { description: @tour.description, destination_id: @tour.destination_id, length: @tour.length, name: @tour.name, price: @tour.price } }
